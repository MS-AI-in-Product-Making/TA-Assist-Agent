...
function dataset(
  observations: readonly FactorMeasurementObservation[],
  options: Pick<FactorMeasurementDataset, "structure" | "rationalSubgroupConfig"> = {
...
describe("buildFactorMeasuredComparison", () => {
  ...
  it("projects actual +/-3 sigma, Setup Cpk, Actual Cpk, and their deltas", () => {
    const result = buildFactorMeasuredComparison({
      ...setup,
      dataset: dataset([
        { originalRow: 1, value: 1, disposition: "included" },
  ...
  it("uses included finite observations only", () => {
    const result = buildFactorMeasuredComparison({
      ...
      dataset: dataset([
        ...
        { originalRow: 2, value: 100, disposition: "excluded" },
  ...
  it("returns undefined with no included finite observations", () => {
    const result = buildFactorMeasuredComparison({
      ...
      dataset: dataset([
        ...
        { originalRow: 2, value: 2, disposition: "excluded" },
      ]),
    });
