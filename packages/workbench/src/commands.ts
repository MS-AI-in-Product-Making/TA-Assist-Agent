...
export const COMMAND_ALLOWLIST: Record<F8SessionState, readonly F8CommandKind[]> = {
  ...
  f0_validated: ["confirm_initial_scope", "auto_confirm_initial_scope", "replace_workbook"],
  initial_scope_required: ["confirm_initial_scope", "auto_confirm_initial_scope", "replace_workbook"],
  f1_f2_running: ["cancel"],
  downstream_scope_required: ["confirm_downstream_scope", "replace_workbook"],
  f3_running: ["cancel"],
  ado_decision_required: ["confirm_ado_decision", "retry", "replace_workbook"],
  ado_action_pending: ["reset_ado_decision", "accept_surface_write", "cancel"],
  f4_running: ["cancel"],
