...
- On the current/default workspace path, publish those five files directly at the validated `06 - F6 Design Optimization` stage root and keep supporting model-response/model-interpretation evidence only under the stage `evidence` folder.
