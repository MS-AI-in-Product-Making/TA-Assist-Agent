...
describe("F7 report PDF renderer", () => {
  it("derives bounded Factor Setup density styles and rejects invalid values", () => {
    ...
    expect(factorSetupDensityStyle(8)).toBe("--factor-setup-table-font-size:5.485714pt;--factor-setup-label-font-size:4.971429pt;--factor-setup-cell-y:1.714286px;--factor-setup-cell-x:2.571429px;--factor-setup-h3-font-size:9pt;--factor-setup-h4-font-size:7.714286pt;--factor-setup-h3-margin-top:7.714286px;--factor-setup-h3-margin-bottom:3.428571px;--factor-setup-h4-margin-top:6.857143px;--factor-setup-h4-margin-bottom:2.571429px;--factor-setup-table-margin:6px;");
    expect(factorSetupDensityStyle(14)).toBe("--factor-setup-table-font-size:2.953846pt;--factor-setup-label-font-size:2.676923pt;--factor-setup-cell-y:0.923077px;--factor-setup-cell-x:1.384615px;--factor-setup-h3-font-size:4.846154pt;--factor-setup-h4-font-size:4.153846pt;--factor-setup-h3-margin-top:4.153846px;--factor-setup-h3-margin-bottom:1.846154px;--factor-setup-h4-margin-top:3.692308px;--factor-setup-h4-margin-bottom:1.384615px;--factor-setup-table-margin:3.230769px;");
    expect(factorSetupDensityStyle(100)).toBe("--factor-setup-table-font-size:0.387879pt;--factor-setup-label-font-size:0.351515pt;--factor-setup-cell-y:0.121212px;--factor-setup-cell-x:0.181818px;--factor-setup-h3-font-size:0.636364pt;--factor-setup-h4-font-size:0.545455pt;--factor-setup-h3-margin-top:0.545455px;--factor-setup-h3-margin-bottom:0.242424px;--factor-setup-h4-margin-top:0.484848px;--factor-setup-h4-margin-bottom:0.181818px;--factor-setup-table-margin:0.424242px;");
  ...
  it("renders the governed report in Web order with chart, comparison, and F0 evidence", () => {
    ...
    for (const metricValue of ["Setup 1.01", "Actual 1.02", "Δ +0.01", "Setup ±0.2", "Actual ±3σ 0.18", "Δ -0.02", "Setup 0.05", "Actual 0.06", "Setup 1", "Actual 0.9"]) {
      expect(measurementAnalysisText).toContain(metricValue);
    }
  ...
  it("keeps extreme finite nominal labels and Factor Setup numeric cells compact", () => {
    ...
    expect(factorSetupNumericCells).toContain("-1.8e308");
    expect(measurementNumericValues.length).toBeGreaterThan(0);
  ...
  it("renders em dashes for absent optional measured metrics without inventing values", () => {
    ...
    expect(measurementAnalysisTable).toBeDefined();
    expect(measurementAnalysisTable?.match(/<span class="metric-label">Actual<\/span><span class="metric-value">—<\/span>/g)).toHaveLength(3);
