...
it("renders metric comparison, contribution, and specification plots", () => {
  ...
  expect(screen.getByText("Mean Offset")).toBeVisible();
  expect(screen.getByLabelText("Mean Offset source values")).toHaveTextContent("Calculated Mean 1.627 minus Target Nominal 1.500 equals 0.127");
...
function worksheet(): WorksheetWorkspaceModel {
  return { worksheetName: "Analysis-A", status: "ready", analysisTarget: { description: "Gap loop", nominal: 1.5, nominalDisplay: "1.500", upperTolerance: 0.1, upperToleranceDisplay: "0.100", lowerTolerance: -0.1, lowerToleranceDisplay: "-0.100", unit: "mm" }, issues: [], factors: [{ key: "key", worksheetName: "Analysis-A", tableId: "table", sourceRow: 1, factorName: projectSourceText("间隙", "Gap"), partName: projectSourceText("部件", "Part"), partCategory: "CNC", unit: "mm", nominalValue: 1, nominalDisplay: "1.000", upperTolerance: 0.2, upperToleranceDisplay: "0.200", lowerTolerance: -0.2, lowerToleranceDisplay: "-0.200", longTermSafetyFactorDisplay: "1.0", sigmaLevelDisplay: "4.0", distribution: "Normal", mean: 1.627, meanDisplay: "1.627", toleranceDisplay: "0.200", oneSigmaDisplay: "0.050", contributionDisplay: "50.0%", capabilityResult: "ready", editable: true, additionalMeanShift: 0, directionLabel: "positive", directionAvailable: true, contribution: 0.5, status: "pass" }], metrics: { mean: 1.627, meanOffset: 0.127, rssSigma: 0.05, cp: 1.4, cpkL: 1.2, cpkU: 1.3, cpk: 1.2, statisticalMargin: 0.2, worstCaseMargin: 0.1, lowerSpecLimit: 1.4, upperSpecLimit: 1.6, meanShift: 0, yield: 0.999, dpm: 1, statisticalLower: 1.427, statisticalUpper: 1.827, worstCaseLower: 1.3, worstCaseUpper: 1.9 } };
}
