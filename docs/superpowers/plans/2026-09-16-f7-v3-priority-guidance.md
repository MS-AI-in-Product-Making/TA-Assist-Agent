...
- [x] **Step 3: Implement the optional field**
...
- [x] **Step 1: Write failing FactorInputTable tests**
...
- [x] **Step 3: Implement selector and draft lifecycle**
...
- [x] **Step 1: Write failing guidance and component tests**
...
- [x] **Step 3: Implement V3 projection and UI**
...
- [x] **Step 1: Write failing PDF contract and renderer tests**
...
- [x] **Step 3: Implement optional PDF fields and request parity**
...
- [x] **Step 4: Run focused and regression validation**
