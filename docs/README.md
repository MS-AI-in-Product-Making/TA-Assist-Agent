...
- **Scope (V1):** No drawing-content **image** reading, no 3D VA. Data-to-drawing linking is done via **DIM ID metadata** (F3); the measured-Cpk closed loop (F8) reads in via manual MDA-export import (MDA API is V2).
